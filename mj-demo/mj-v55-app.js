(()=>{
 ...
 const salon={
  'photo-01':'./assets/images/photo-01.avif?v=54','photo-02':'./assets/images/photo-02.avif?v=54',
  'photo-04':'./assets/images/photo-04.avif?v=54','photo-05':'./assets/images/photo-05.avif?v=54',
  'photo-06':'./assets/images/photo-06.avif?v=54','photo-07':'./assets/images/photo-07.avif?v=54','photo-08':'./assets/images/photo-08.avif?v=54'};
 ...
 const mobileHero=matchMedia('(max-width:700px)').matches;
 if(window.MJ?.HERO){bg1.style.backgroundImage=`linear-gradient(90deg,rgba(4,7,11,.58) 0%,rgba(4,7,11,.28) 55%,rgba(4,7,11,.10) 100%),url("${window.MJ.HERO}")`;bg1.style.backgroundSize='cover';bg1.style.backgroundPosition=mobileHero?'center top':'center';bg1.style.backgroundRepeat='no-repeat';}
 else paint(bg1,'photo-01');
 if(mobileHero){bg2.style.display='none';}else{bg2.style.backgroundImage=`linear-gradient(90deg,rgba(4,7,11,.30),rgba(4,7,11,.62)),url("${salon['photo-02']}")`;bg2.style.backgroundSize='cover';bg2.style.backgroundPosition='center';bg2.style.backgroundRepeat='no-repeat';}
 ...
 function hero(){
  ...
  if(mobileHero){bg1.style.opacity=1;}else{bg1.style.opacity=1-mix*.72;bg1.style.transform=`scale(${1+p*.055}) translate3d(0,${-p*22}px,0)`;bg2.style.opacity=mix*.78;bg2.style.transform=`scale(${1.06-mix*.025}) translate3d(0,${-mix*12}px,0)`;}
 ...
 const state={service:'Hair Care',time:'7:30 PM',name:'',phone:''},book=q('#booking'),steps=qa('.step'),flow=[0,1,2];let step=0;
